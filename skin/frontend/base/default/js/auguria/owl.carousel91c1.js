...
;(function($, window, document, undefined) {
	...
	function Owl(element, options) {
		...
		jQuery.each([ 'onResize', 'onThrottledResize' ], $.proxy(function(i, handler) {
			this._handlers[handler] = $.proxy(this[handler], this);
		}, this));

		jQuery.each(Owl.Plugins, $.proxy(function(key, plugin) {
			this._plugins[key.charAt(0).toLowerCase() + key.slice(1)]
				= new plugin(this);
		}, this));

		jQuery.each(Owl.Workers, $.proxy(function(priority, worker) {
			this._pipe.push({
